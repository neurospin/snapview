...
(function() {
  ...
  function createMincVolume(header, raw_data, callback){
    ...
    var volume = {
      ...
      slice: function(axis, slice_num, time) {
        ...
        var slice_data = new Uint16Array(width * height);
  ...
  BrainBrowser.createMincVolume = createMincVolume
  BrainBrowser.parseHeader = parseHeader
