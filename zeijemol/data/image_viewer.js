...
$(function() {
  ...
  window.viewer = BrainBrowser.VolumeViewer.start("brainbrowser", function(viewer) {
    ...
    $("#panel-size").change(function() {
      ...
      var margin_left = parseInt($(".slice-display").css("margin-left"))
      var margin_right = parseInt($(".slice-display").css("margin-right"))
      var wrapper_width = 2*(size + margin_left + margin_right)
      $('#brainbrowser-wrapper').css('width', wrapper_width + 'px');
